...
JOIN \"Employee\" USING (\"ID_individual\") WHERE \"ID_employee\"=$deleteid";
$individual = resultNumber($individual, $db_connect);

$account="
SELECT \"ID_account\" FROM \"Account\"
JOIN \"Employee\" USING (\"ID_account\") WHERE \"ID_employee\"=$deleteid";
...
$query="
DELETE FROM \"Employee\" WHERE \"ID_employee\"=$deleteid";
...
echo "Запись с кодом сотрудника $deleteid успешно удалена";
