...
require_once '../../vendor/db_connect.php';
    ...
    $query = "
    SELECT * FROM filtering_debit_card_all($cashback_percentage_from,$cashback_percentage_to,$maintenance_cost_from,$maintenance_cost_to,'$category_var','$sort_column','$sort_type')";
